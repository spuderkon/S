							...
							<form action="{{ route('changeInfo_process')}}" method="POST" id="contact_form" class="contact_form">
								...
								<div class="row">
									<div class="col-xl-6">
										...
										<input type="text" id="name" name="name" class="contact_input" placeholder="Имя" value="{{$User->name}}">
										@error('login')
								...
								<div>
									...
									<input type="text" id="email" name="email" class="contact_input" placeholder="Почта" value="{{$User->email}}">
									 @error('login')
									<div class="alert alert-danger">{{$message}}</div>
									@enderror
								</div>
								<div>
									...
									<input type="text" id="phone" name="phone" class="contact_input" placeholder="Номер телефона" value="{{$User->phone}}">
									 @error('phone')
									<div class="alert alert-danger">{{$message}}</div>
									@enderror
								</div>
